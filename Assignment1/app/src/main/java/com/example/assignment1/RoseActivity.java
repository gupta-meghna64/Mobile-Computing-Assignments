...
public class RoseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            final ScrollView scrollView = findViewById(R.id. rose_scrollView);
        ...
        Toast.makeText(this, this.getString(R.string.rose), Toast.LENGTH_SHORT).show();
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent lily_intent = new Intent(RoseActivity.this, MainActivity.class);
        ...
        lilyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent rose_intent = new Intent(RoseActivity.this, LilyActivity.class);
        ...
        lotusButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent lotus_intent = new Intent(RoseActivity.this, LotusActivity.class);
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        ScrollView scrollView = findViewById(R.id. rose_scrollView);
